...
const visiblePages = computed(() => {
  ...
  // Si total ≤ 4, on affiche toutes les pages
  ...
  if (current <= 2) {
    ...
    // Pagination centrée autour de la page active
...
<div v-if="totalPages > 1" class="flex justify-end items-center gap-4 mt-6 " style="
    margin-top: 43px;
">
  <!-- Précédent -->
  <button
