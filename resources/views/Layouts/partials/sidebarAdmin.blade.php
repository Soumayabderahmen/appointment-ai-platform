<aside id="layout-menu" class="aside layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
                    ...
                    <span class="iconify" data-icon="mdi:account-group" data-inline="false"></span>
                        ...
                        <div data-i18n="Liste des Startups">Liste des Startups</div>
                ...
                <li class="menu-item">
                    ...
                    <span class="iconify" data-icon="mdi:account-group" data-inline="false"></span>
                        ...
                        <div data-i18n="Liste des Coaches">Liste des Coaches</div>
                ...
                <li class="menu-item">
                    ...
                    <span class="iconify" data-icon="mdi:account-group" data-inline="false"></span>
                        ...
                        <div data-i18n="Liste des Investisseurs">Liste des Investisseurs</div>
    ...
    <li class="menu-item">
                    <a href="{{ route('admin.categorie.index') }}" class="menu-link">
                     <i class="menu-icon">
                    <span class="iconify" data-icon="mdi:account-group" data-inline="false"></span>
                </i>
                ...
                <li class="menu-item">
                    <a href="{{ route('admin.list.publication') }}" class="menu-link">
                     <i class="menu-icon">
                    <span class="iconify" data-icon="mdi:account-group" data-inline="false"></span>
                </i>
                        <div data-i18n="Gestion des financements">Gestion des financements</div>
    ...
    @if(Auth::user()->admin && Auth::user()->admin->profile_image)
        <img 
            src="{{ asset('storage/' . Auth::user()->admin->profile_image) }}" 
            alt="Photo de profil" 
